...
function Slider(slider) {
  ...
  this.slider = slider; // select the element needed for the slider

  this.slides = this.slider.querySelector('.slides');
  var prevButton = this.slider.querySelector('.goToPrev');
  var nextButton = this.slider.querySelector('.goToNext'); // when this slider is created, run the start slider function
